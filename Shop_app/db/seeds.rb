...
p76 = Product.create(catogory: 'Fragile', img: Rails.root.join("app/assets/images/fiagile_big.jpg").open )
...
p86 = Product.create(catogory: 'Home', img: Rails.root.join("app/assets/images/home_big.jpg").open )
...
p96 = Product.create(catogory: 'Light', img: Rails.root.join("app/assets/images/light_big_1.jpg").open )

p18 = Product.create(name: 'Liquid 1', designer: 'Anne', price: 310, img: Rails.root.join("app/assets/images/name_1.jpg").open)
p19 = Product.create(name: 'Liquid 2', designer: 'me', price: 40, img: Rails.root.join("app/assets/images/name_2.jpg").open)
...
p78 = Product.create(catogory: 'Paper', img: Rails.root.join("app/assets/images/paper_big.jpg").open )
...
p68 = Product.create(catogory: 'Soft', img: Rails.root.join("app/assets/images/soft_big.jpg").open )
